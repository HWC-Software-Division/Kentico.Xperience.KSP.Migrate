  ...
  return (
    <div style={{padding:24, fontFamily:"system-ui, sans-serif"}}>
      ...
      <div onClick={()=>fileRef.current?.click()}
        ...
        <input ref={fileRef} type="file" accept=".zip" style={{display:"none"}} onChange={e=>handleFile(e.target.files?.[0]??null)}/>
        {file ? (
          <>
      ...
      {status==="success" && result != null && <div style={{padding:"11px 14px", marginBottom:14, borderRadius:7, background:"#eaf3de", border:"0.5px solid #c0dd97", color:"#3b6d11", fontSize:13}}>Import complete — {result.created} created, {result.updated} updated.</div>}
      ...
      <div style={{display:"flex", gap:8}}>
        ...
        {file != null && <button onClick={()=>{setFile(null); setStatus("idle"); setResult(null);}}
